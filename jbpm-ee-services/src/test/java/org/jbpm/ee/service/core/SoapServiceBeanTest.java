...
public class SoapServiceBeanTest extends JBPMServiceTest {
	...
	public ProcessService getProcessService() {
		try {
			return SoapClientFactory.getProcessService("http://localhost:8080/jbpm-ee-services/ProcessService?wsdl");
	...
	public TaskService getTaskService() {
		try {
			return SoapClientFactory.getTaskService("http://localhost:8080/jbpm-ee-services/TaskService?wsdl");
		} catch (ClientException e) {
			throw new RuntimeException(e);
		}
	}
