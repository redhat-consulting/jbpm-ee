...
public class RestServiceBeanTest extends JBPMServiceTest {
	...
	public ProcessService getProcessService() {
		return RestClientFactory.getProcessService("http://localhost:8080/jbpm-ee-services/rest");
	}
	
	public TaskService getTaskService() {
		return RestClientFactory.getTaskService("http://localhost:8080/jbpm-ee-services/rest");
	}
